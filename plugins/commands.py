...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            try:
                ...
                await client.send_message(LOG_CHANNEL, "Hello Nanba test4❤️‍🔥")
                await meg.copy(chat_id = LOG_CHANNEL, disable_notification=True)
                ...
                await client.send_message(FILE_STORE_CHANNEL, "Hello Nanba NEW🔥🔥❤️‍🔥")
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('Subscribe', url='https://youtube.com/c/jvncreation') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
